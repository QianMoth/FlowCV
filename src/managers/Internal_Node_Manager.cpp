...
#include "../nodes/internal_nodes.hpp"
...
InternalNodeManager::InternalNodeManager()
{
    ...
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Viewer>(DSPatch::DSPatchables::Viewer()));

    // Blur
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Blur>(DSPatch::DSPatchables::Blur()));

    // Transform
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Transform>(DSPatch::DSPatchables::Transform()));

    // Canny
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::CannyFilter>(DSPatch::DSPatchables::CannyFilter()));

    // Hough Circles
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::HCircles>(DSPatch::DSPatchables::HCircles()));

    // Blob Detector
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::BlobDetector>(DSPatch::DSPatchables::BlobDetector()));

    // JSON Viewer
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::JsonViewer>(DSPatch::DSPatchables::JsonViewer()));

    // Morphological Operations
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Morphology>(DSPatch::DSPatchables::Morphology()));

    // Convert Color
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::ConvertColor>(DSPatch::DSPatchables::ConvertColor()));

    // Threshold
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Threshold>(DSPatch::DSPatchables::Threshold()));

    // Normalize
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Normalize>(DSPatch::DSPatchables::Normalize()));

    // Background Subtraction
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::BackgroundSubtraction>(
        DSPatch::DSPatchables::BackgroundSubtraction()));

    // Bitwise
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Bitwise>(DSPatch::DSPatchables::Bitwise()));

    // Contours
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Contours>(DSPatch::DSPatchables::Contours()));

    // Crop
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Crop>(DSPatch::DSPatchables::Crop()));

    // Color Correct
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Colorcorrect>(DSPatch::DSPatchables::Colorcorrect()));

    // Draw Text
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::DrawText>(DSPatch::DSPatchables::DrawText()));

    // Draw Number
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::DrawNumber>(DSPatch::DSPatchables::DrawNumber()));

    // Draw Date Time
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::DrawDateTime>(DSPatch::DSPatchables::DrawDateTime()));

    // Draw JSON
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::DrawJson>(DSPatch::DSPatchables::DrawJson()));

    // Resize
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Resize>(DSPatch::DSPatchables::Resize()));

    // Get Size
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::GetSize>(DSPatch::DSPatchables::GetSize()));

    // Get Optimal DFT Size
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::GetOptimalDft>(DSPatch::DSPatchables::GetOptimalDft()));

    // Discrete Fourier Transform
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::DiscreteFourierTransform>(
        DSPatch::DSPatchables::DiscreteFourierTransform()));

    // Discrete Cosine Transform
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::DiscreteCosineTransform>(
        DSPatch::DSPatchables::DiscreteCosineTransform()));

    // Copy Make Border
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::CopyMakeBorder>(
        DSPatch::DSPatchables::CopyMakeBorder()));

    // Mean
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Mean>(DSPatch::DSPatchables::Mean()));

    // Scharr
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::ScharrFilter>(DSPatch::DSPatchables::ScharrFilter()));

    // Sobel
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::SobelFilter>(DSPatch::DSPatchables::SobelFilter()));

    // Laplacian
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::LaplacianFilter>(
        DSPatch::DSPatchables::LaplacianFilter()));

    // Convert Scale Abs
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::ScaleAbs>(DSPatch::DSPatchables::ScaleAbs()));

    // Add Weighted
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::AddWeighted>(DSPatch::DSPatchables::AddWeighted()));
    ...
    // Abs Diff
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::AbsDiff>(DSPatch::DSPatchables::AbsDiff()));

    // Divide
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Divide>(DSPatch::DSPatchables::Divide()));
    ...
    // Multiply
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Multiply>(DSPatch::DSPatchables::Multiply()));

    // Subtract
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Subtract>(DSPatch::DSPatchables::Subtract()));

    // Magnitude
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Magnitude>(DSPatch::DSPatchables::Magnitude()));

    // Random Noise
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::RndNoise>(DSPatch::DSPatchables::RndNoise()));

    // Histogram Viewer
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::HistogramViewer>(
        DSPatch::DSPatchables::HistogramViewer()));

    // Color Reduce
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::ColorReduce>(DSPatch::DSPatchables::ColorReduce()));

    // Depth Viewer 3D
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::DepthViewer3D>(DSPatch::DSPatchables::DepthViewer3D()));

    // Hough Lines
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::HoughLines>(DSPatch::DSPatchables::HoughLines()));

    // Solid
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Solid>(DSPatch::DSPatchables::Solid()));

    // Line Intersect
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::LineIntersect>(DSPatch::DSPatchables::LineIntersect()));

    // Perspective Warp
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::PerspectiveWarp>(
        DSPatch::DSPatchables::PerspectiveWarp()));

    // Sharpen
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Sharpen>(DSPatch::DSPatchables::Sharpen()));

    // Split
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Split>(DSPatch::DSPatchables::Split()));

    // Combine
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Combine>(DSPatch::DSPatchables::Combine()));

    // DNN - Classification
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::Classification>(
        DSPatch::DSPatchables::Classification()));

    // DNN - Object Detection
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::ObjectDetection>(
        DSPatch::DSPatchables::ObjectDetection()));

    // DNN - Segmentation
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::Segmentation>(DSPatch::DSPatchables::Segmentation()));

    // DNN - Human Pose
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::HumanPose>(DSPatch::DSPatchables::HumanPose()));

    // DNN - Text Detection
    node_list_.emplace_back(
        GetCompInfo<DSPatch::DSPatchables::TextDetection>(DSPatch::DSPatchables::TextDetection()));

    // DNN - Text Recognition
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::TextRecognition>(
        DSPatch::DSPatchables::TextRecognition()));

    // DNN - Image Processing
    node_list_.emplace_back(GetCompInfo<DSPatch::DSPatchables::ImageProcessing>(
        DSPatch::DSPatchables::ImageProcessing()));
