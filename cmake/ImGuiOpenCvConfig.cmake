...
if(NOT USE_LOCAL_OPENCV_PACKAGE)
    if(WIN32)
        ...
        if(NOT EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/opencv*")
            # Download OpenCV
            if((DEFINED CMAKE_BUILD_TYPE) AND(CMAKE_BUILD_TYPE STREQUAL "Debug"))
                message(WARNING "See https://github.com/FlowCV-org/FlowCV/issues/8")
            elseif(NOT EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/opencv/build/lib/opencv_core455.lib")
                ...
                file(DOWNLOAD https://github.com/opencv/opencv/releases/download/4.5.5/opencv-4.5.5-openvino-dldt-2021.4.2-vc16-avx2.7z
                    "${CMAKE_SOURCE_DIR}/3rdparty/${OPENCV_FILE_NAME_RELEASE}"
                    EXPECTED_HASH SHA256=f76c83db33815ce27144c6b20ed37e8f0b4ae199ad9b3a0291ccfcf7b0fb2703
                )
                message(STATUS "Download Complete")
            else()
                message(STATUS "OpenCV Package Already Exists In ${CMAKE_SOURCE_DIR}/3rdparty/opencv")
            endif()
        endif()
        ...
        if(NOT EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/opencv")
            ...
            file(ARCHIVE_EXTRACT INPUT "${CMAKE_SOURCE_DIR}/3rdparty/${OPENCV_FILE_NAME_RELEASE}" DESTINATION "${CMAKE_SOURCE_DIR}/3rdparty/")
            message(STATUS "Files Extracted")
            message(STATUS "Removing Archive")
            file(REMOVE "${CMAKE_SOURCE_DIR}/3rdparty/${OPENCV_FILE_NAME_RELEASE}")
        endif()

        # Set OpenCV_DIR
        set(OpenCV_DIR "${CMAKE_SOURCE_DIR}/3rdparty/opencv/build/cmake")
...
set(IMGUI_OPENCV_DIR ${CMAKE_SOURCE_DIR}/3rdparty/imgui_wrapper)
