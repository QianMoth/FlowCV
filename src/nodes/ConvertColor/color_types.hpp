...
const std::vector<std::string> ConvertColorNames = {
    ...
    "BGR2Luv", "RGB2Luv", "BGR2HLS", "RGB2HLS",
    ...
    // COLOR_YUV2RGB_VYUY = 109,
    // COLOR_YUV2BGR_VYUY = 110,
    "YUV2RGB_Y422", "YUV2BGR_Y422", "YUV2RGB_UYNV", "YUV2BGR_UYNV",

    "YUV2RGBA_UYVY", "YUV2BGRA_UYVY",
    // COLOR_YUV2RGBA_VYUY = 113,
    // COLOR_YUV2BGRA_VYUY = 114,
    ...
    // CV_YUV2GRAY_VYUY    = CV_YUV2GRAY_UYVY,
    "YUV2GRAY_Y422", "YUV2GRAY_UYNV", "YUV2GRAY_YVYU", "YUV2GRAY_YUYV", "YUV2GRAY_YUNV",
    ...
    //! Demosaicing using Variable Number of Gradients
    "BayerBG2BGR_VNG", "BayerGB2BGR_VNG", "BayerRG2BGR_VNG", "BayerGR2BGR_VNG",

    "BayerBG2RGB_VNG", "BayerGB2RGB_VNG", "BayerRG2RGB_VNG", "BayerGR2RGB_VNG",

    //! Edge-Aware Demosaicing
    "BayerBG2BGR_EA", "BayerGB2BGR_EA", "BayerRG2BGR_EA", "BayerGR2BGR_EA",

    "BayerBG2RGB_EA", "BayerGB2RGB_EA", "BayerRG2RGB_EA", "BayerGR2RGB_EA",

    //! Demosaicing with alpha channel
    "BayerBG2BGRA", "BayerGB2BGRA", "BayerRG2BGRA", "BayerGR2BGRA",

    "BayerBG2RGBA", "BayerGB2RGBA", "BayerRG2RGBA", "BayerGR2RGBA"};
